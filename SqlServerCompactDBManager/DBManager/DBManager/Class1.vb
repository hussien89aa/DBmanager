...
Public Class ColoumnParam
    ...
    Public ColoumnsName As String
    Public ColoumnsType As ColoumnType
    Public ColoumnsData As Object
...
Public Class DBOpeartion
    Public connectionString As String ' Private mean it declarted only on it page we use Public becaouse it may shange it connection string
    Private SQLString As String   ' the sql string we userd in database
    Private ErrorHappend As String  ' erro happned in data base 
    ...
    Public Function InsertRow(ByVal TabelName As String, ByVal coloumns() As ColoumnParam) As Boolean
        Try
            ...
            Using conn As New SqlCeConnection(connectionString)
                Using comm As New SqlCeCommand()
                    With comm
                        .Connection = conn
            ...
            Using conn As New SqlCeConnection(connectionString)
                Using comm As New SqlCeCommand()
                    ...
                    Try
                        ...
                        conn.Open()
                        Dim DataAdapter1 As New SqlCeDataAdapter(comm)
